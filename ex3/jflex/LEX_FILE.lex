...
{TYPE1_COMMENT}			{}
{TYPE2_COMMENT}			{}
{INVALID_INTEGER}		{throw new Exception("LEXICAL ERROR: integer out of bounds");}
...
{INVALID_ID}			{throw new Exception("LEXICAL ERROR: invalid id"); }
{COMMENT_ERROR}                 { throw new Exception("LEXICAL ERROR: invalid comment");}
